...
public class HighGoalVision {
  ...
  static Mat imageRs = new Mat();
  static Mat imageBlur = new Mat();
  static Mat imageHsv = new Mat();
  static Mat imageMask = new Mat();
  static Mat contourHierarchy = new Mat();

  static List<MatOfPoint> contours = new ArrayList<>();
  static ArrayList<TargetLocation> targets = new ArrayList<>();
